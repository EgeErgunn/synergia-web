...
export const TOPIC_CATEGORIES: Record<string, CategoryKey> = {
  ...
  'Politikacı Olma Potansiyeli' : 'verbal',
  ...
  'Hayvan Sevgisi' : 'social',
  'Tarih Bilgisi' : 'verbal',
  'Fotoğraf Çekebilme' : 'creative',
  'Yabancı Dil Yeteneği' : 'verbal',
  'Yön Duygusu' : 'analytical',
  'Hikaye Anlatıcılığı' : 'verbal',
  'İkna Kabiliyeti' : 'verbal',
  'Rahatlık' : 'social',
  'Soğuğa/Sıcağa Dayanıklılık' : 'kinesthetic',
  'Hızlı Koşabilme' : 'kinesthetic',
  'İlk İzlenim' : 'social',
  'Mantıklı Tartışma': 'analytical',
  'Empati': 'social',
  'Selam Verme Tarzı': 'social',
  'Kelime Haznesi': 'verbal',
  'Kelime Oyunları/Dum': 'verbal',
  'Takma İsim Bulma': 'creative',
  'Senaryo/Hikaye Uydurma': 'creative',
